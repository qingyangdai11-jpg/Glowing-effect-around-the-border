Shader "Unlit/Btn1Shader"
{
    Properties
    {
        ...
        [Header(Border)]
        _BorderWidth ("Border Width", Range(0.0, 0.1)) = 0.02
        _BorderColor ("Border Color", Color) = (0.2, 0.2, 0.2, 0.5)
        
        [Header(Glow)]
        [HDR] _GlowColor ("Glow Color (HDR)", Color) = (0.0, 1.0, 1.0, 1.0)
        _GlowSize ("Glow Size (Length)", Range(0.01, 1.5)) = 0.4
        _GlowSpeed ("Glow Speed", Float) = 2.0
        _Light1Speed ("Light 1 Speed Mult", Float) = 1.0
        _Light2Speed ("Light 2 Speed Mult", Float) = -1.0
        _LightSeparation ("Light 2 Offset (Deg)", Range(0.0, 360.0)) = 180.0
        _GlowIntensity ("Glow Intensity", Float) = 3.0
        _InnerSoftness ("Inner Softness", Range(0.1, 100.0)) = 20.0
        _OuterSoftness ("Outer Softness", Range(0.1, 100.0)) = 20.0
        
        [Header(Noise Shimmer)]
        _NoiseScale ("Noise Scale", Float) = 10.0
        _NoiseSpeed ("Noise Speed", Float) = 5.0
        _NoiseStrength ("Noise Strength", Range(0.0, 0.5)) = 0.05
